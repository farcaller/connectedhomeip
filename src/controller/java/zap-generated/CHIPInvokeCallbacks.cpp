...
CHIPEvseManagementClusterGetTargetsResponseCallback::CHIPEvseManagementClusterGetTargetsResponseCallback(jobject javaCallback) :
    Callback::Callback<CHIPEvseManagementClusterGetTargetsResponseCallbackType>(CallbackFn, this)
{
    JNIEnv * env = JniReferences::GetInstance().GetEnvForCurrentThread();
    if (env == nullptr)
    {
...
CHIPEvseManagementClusterGetTargetsResponseCallback::~CHIPEvseManagementClusterGetTargetsResponseCallback()
{
    JNIEnv * env = JniReferences::GetInstance().GetEnvForCurrentThread();
    if (env == nullptr)
    {
...
void CHIPEvseManagementClusterGetTargetsResponseCallback::CallbackFn(
    void * context, const chip::app::Clusters::EvseManagement::Commands::GetTargetsResponse::DecodableType & dataResponse)
{
    chip::DeviceLayer::StackUnlock unlock;
    CHIP_ERROR err = CHIP_NO_ERROR;
    JNIEnv * env   = JniReferences::GetInstance().GetEnvForCurrentThread();
    ...
    std::unique_ptr<CHIPEvseManagementClusterGetTargetsResponseCallback,
                    void (*)(CHIPEvseManagementClusterGetTargetsResponseCallback *)>
        cppCallback(reinterpret_cast<CHIPEvseManagementClusterGetTargetsResponseCallback *>(context),
                    chip::Platform::Delete<CHIPEvseManagementClusterGetTargetsResponseCallback>);
    VerifyOrReturn(cppCallback != nullptr, ChipLogError(Zcl, "Error invoking Java callback: failed to cast native callback"));
