...
class ElectricalEnergyMeasurementClusterPeriodicEnergyConsumedEvent(
  val periodStart: Long,
  val periodEnd: Long,
  val energyConsumed: Long
) {
  override fun toString(): String = buildString {
    append("ElectricalEnergyMeasurementClusterPeriodicEnergyConsumedEvent {\n")
  ...
  companion object {
    ...
    fun fromTlv(
      tag: Tag,
      tlvReader: TlvReader
    ): ElectricalEnergyMeasurementClusterPeriodicEnergyConsumedEvent {
      ...
      return ElectricalEnergyMeasurementClusterPeriodicEnergyConsumedEvent(
        periodStart,
        periodEnd,
        energyConsumed
      )
