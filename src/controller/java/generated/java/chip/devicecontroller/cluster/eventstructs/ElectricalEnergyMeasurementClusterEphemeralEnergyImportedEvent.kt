...
class ElectricalEnergyMeasurementClusterEphemeralEnergyImportedEvent(
  ...
  companion object {
    ...
    fun fromTlv(
      ...
      val importedTimestamp = tlvReader.getLong(ContextSpecificTag(TAG_IMPORTED_TIMESTAMP))
      val energyImported = tlvReader.getLong(ContextSpecificTag(TAG_ENERGY_IMPORTED))
