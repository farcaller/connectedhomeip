...
class EnergyEvseClusterEVNotDetectedEvent(
  ...
  companion object {
    ...
    fun fromTlv(tag: Tag, tlvReader: TlvReader): EnergyEvseClusterEVNotDetectedEvent {
      ...
      val sessionDuration = tlvReader.getLong(ContextSpecificTag(TAG_SESSION_DURATION))
