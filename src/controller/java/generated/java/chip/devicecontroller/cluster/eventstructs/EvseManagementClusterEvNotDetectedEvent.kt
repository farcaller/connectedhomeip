...
class EvseManagementClusterEvNotDetectedEvent (
  ...
  override fun toString(): String  = buildString {
    ...
    append("\tevseSessionEnergyCharged : $evseSessionEnergyCharged\n")
    append("\tevseSessionEnergyDischarged : $evseSessionEnergyDischarged\n")
    append("}\n")
  }
  ...
  fun toTlv(tag: Tag, tlvWriter: TlvWriter) {
    tlvWriter.apply {
      ...
      put(ContextSpecificTag(TAG_EVSE_SESSION_ENERGY_CHARGED), evseSessionEnergyCharged)
      put(ContextSpecificTag(TAG_EVSE_SESSION_ENERGY_DISCHARGED), evseSessionEnergyDischarged)
      endStructure()
    }
  }
