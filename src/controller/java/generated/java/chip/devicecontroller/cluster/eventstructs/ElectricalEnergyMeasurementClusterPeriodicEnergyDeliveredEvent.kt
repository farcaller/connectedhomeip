...
class ElectricalEnergyMeasurementClusterPeriodicEnergyDeliveredEvent(
  val periodStart: Long,
  val periodEnd: Long,
  val energyDelivered: Long
) {
  override fun toString(): String = buildString {
    append("ElectricalEnergyMeasurementClusterPeriodicEnergyDeliveredEvent {\n")
  ...
  companion object {
    ...
    private const val TAG_ENERGY_DELIVERED = 2

    fun fromTlv(
      tag: Tag,
      tlvReader: TlvReader
    ): ElectricalEnergyMeasurementClusterPeriodicEnergyDeliveredEvent {
      ...
      return ElectricalEnergyMeasurementClusterPeriodicEnergyDeliveredEvent(
        periodStart,
        periodEnd,
        energyDelivered
      )
