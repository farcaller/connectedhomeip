...
class DeviceEnergyManagementClusterPowerLimitsStruct(
  val startTime: Long,
  val duration: Long,
  ...
  override fun toString(): String = buildString {
    append("DeviceEnergyManagementClusterPowerLimitsStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(tag: Tag, tlvReader: TlvReader): DeviceEnergyManagementClusterPowerLimitsStruct {
      ...
      return DeviceEnergyManagementClusterPowerLimitsStruct(
        startTime,
        duration,
        nominalPower,
        maximumEnergy
