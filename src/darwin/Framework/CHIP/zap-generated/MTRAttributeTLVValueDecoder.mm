...
static id _Nullable DecodeAttributeValueForEnergyManagementCluster(AttributeId aAttributeId, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
...
static id _Nullable DecodeAttributeValueForEVSEManagementCluster(AttributeId aAttributeId, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
...
static id _Nullable DecodeAttributeValueForWaterHeaterCluster(AttributeId aAttributeId, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
