...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: minDuration:%@; maxDuration:%@; defaultDuration:%@; elapsedSlotTime:%@; remainingSlotTime:%@; slotIsPauseable:%@; nominalPower:%@; minPower:%@; maxPower:%@; nominalEnergy:%@; costs:%@; minPowerAdjustment:%@; maxPowerAdjustment:%@; minimumDurationAdjustment:%@; maximumDurationAdjustment:%@; >", NSStringFromClass([self class]),_minDuration,_maxDuration,_defaultDuration,_elapsedSlotTime,_remainingSlotTime,_slotIsPauseable,_nominalPower,_minPower,_maxPower,_nominalEnergy,_costs,_minPowerAdjustment,_maxPowerAdjustment,_minimumDurationAdjustment,_maximumDurationAdjustment];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: startTime:%@; duration:%@; nominalPower:%@; maximumEnergy:%@; >", NSStringFromClass([self class]),_startTime,_duration,_nominalPower,_maximumEnergy];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: evseSessionId:%@; evseState:%@; >", NSStringFromClass([self class]),_evseSessionId,_evseState];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: evseSessionId:%@; evseState:%@; evseSessionDuration:%@; evseSessionEnergyCharged:%@; evseSessionEnergyDischarged:%@; >", NSStringFromClass([self class]),_evseSessionId,_evseState,_evseSessionDuration,_evseSessionEnergyCharged,_evseSessionEnergyDischarged];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: evseSessionId:%@; evseState:%@; evseSessionDuration:%@; >", NSStringFromClass([self class]),_evseSessionId,_evseState,_evseSessionDuration];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: evseSessionId:%@; evseState:%@; reason:%@; energyTransferred:%@; >", NSStringFromClass([self class]),_evseSessionId,_evseState,_reason,_energyTransferred];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: evseSessionId:%@; evseState:%@; evseFaultPreviousState:%@; evseFaultCurrentState:%@; >", NSStringFromClass([self class]),_evseSessionId,_evseState,_evseFaultPreviousState,_evseFaultCurrentState];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: uid:%@; >", NSStringFromClass([self class]),_uid];
  return descriptionString;
}
