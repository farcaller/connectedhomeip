...
@property (nonatomic, copy) NSNumber * _Nullable enableChargeTime MTR_NEWLY_AVAILABLE;
...
@property (nonatomic, copy) NSNumber * _Nullable enableDischargeTime MTR_NEWLY_AVAILABLE;
