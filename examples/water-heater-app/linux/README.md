# CHIP Linux Water Heater Example

An example showing the use of CHIP on the Linux. The document will describe how
to build and run CHIP Linux Water Heater Example on Raspberry Pi. This doc is tested
...
-   [CHIP Linux Water Heater Example](#chip-linux-water-heater-example)
    -   [Building](#building)
...
-   Running
    ...
    -   [Optional] Plug USB Bluetooth dongle
        ...
        -   Run Linux Water Heater Example App
                  ...
                  $ cd ~/connectedhomeip/examples/water-heater-app/linux
                  $ sudo out/debug/chip-water-heater-app --ble-device [bluetooth device number]
                  # In this example, the device we want to use is hci1
                  $ sudo out/debug/chip-water-heater-app --ble-device 1
...
-   Then you can Get and Set the water heater using the RPCs:
    `rpcs.chip.rpc.WaterHeater.Get()`
